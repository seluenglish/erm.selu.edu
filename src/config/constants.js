...
export const SERVER_XML_DIRECTORY = `${SERVER_ROOT}/xml`
export const SERVER_SHOWCASE_DIRECTORY = `${SERVER_ROOT}/showcase`
export const SERVER_HTML_DIRECTORY = `${SERVER_ROOT}/html`
