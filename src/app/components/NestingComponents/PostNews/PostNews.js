            ...
            {this.props.location.state?(
              <Form onSubmit={(e)=>this.handleForm(e)}>
                ...
                <Form.Row>
                  ...
                  <Form.Group as={Col} controlId='formGridEmail'>
                    ...
                    <Form.Control
                      ...
                      value={`${this.state.title}`} placeholder={`${this.props.location.state.title}`}
                  ...
                  <Form.Group as={Col} controlId='formGridPassword'>
                    <Form.Group as={Col} controlId='formGridEmail'>
                      <Form.Control
                        ...
                        value={`${this.state.imgUrl}`} placeholder={`${this.props.location.state.imgUrl}`}
                        onChange={(e)=>this.change(e)}
                      />
                ...
                <Form.Row style={{ border:'inset' }}>
                  <textarea
                    style={{ height:'250px', width:'100%' }} name='description'
                    value={`${this.state.description}`} placeholder={`${this.props.location.state.description}`}
                    onChange={(e)=>this.change(e)}
                  />
                    ...
                    <Form onSubmit={(e)=>this.handleForm(e)}>
                      <Form.Row>
                        <Form.Group as={Col} controlId='formGridEmail'>
                          ...
                          <Form.Control
                            type='text' name='title'
                            placeholder='Enter post title' onChange={(e)=>this.change(e)}
                          />
                          <span className={'validationError'}>{this.state.titleError}</span>
                        </Form.Group>
                      </Form.Row>
                      ...
                      <Form.Row>
                        ...
                        <Form.Group as={Col} controlId='formGridPassword'>
                          <Form.Group as={Col} controlId='formGridEmail'>
                            <Form.Control
                              type='text' name='imgUrl'
                              placeholder='Enter image link' onChange={(e)=>this.change(e)}
                            />
                            <span className={'validationError'}>{this.state.imgUrlError}</span>
                          </Form.Group>
                        </Form.Group>
                      ...
                      <Form.Row style={{ border:'inset' }}>
                        <textarea
                          style={{ height:'250px', width:'100%' }} name='description'
                          placeholder={'Write your post description here!'} onChange={(e)=>this.change(e)}
                        />
                        <span className={'validationError'}>{this.state.descriptionError}</span>
                      </Form.Row>
                      <br />
